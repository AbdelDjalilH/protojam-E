    ...
    <>
      ...
      <div className="grid grid-cols-3 gap-y-20 gap-x-10 p-5 justify-items-center">
        <Link to={`Filter/Nuit insolite`}>
          <div className="w-80 max-w-sm rounded overflow-hidden shadow-lg hover:scale-95 transition-transform border bg-slate-50 border-teal-400">
            <img
        ...
        <Link to={`Filter/Parc`}>
          <div className="w-80 maw-w-sm rounded overflow-hidden shadow-lg hover:scale-95 transition-transform border bg-slate-50 border-teal-400">
            <img
              className="border rounded-t-md w-full h-60 object-cover"
